...
const PublishForm = () => {
  ...
  const handleKeyDown=(e)=>{
    if(e.key=="Enter" || e.keyCode==188){
      ...
      if(tags.length<tagLimit){
        ...
        toast.error(`Maximum tags limit is ${tagLimit}`)
      }
      e.target.value="";
    }
  }
  ...
  const publishBlog=(e)=>{
    ...
    if(!tags.length){
      return toast.error("Ensure you enter at least one tag to improve the ranking of your blog")
    }
  ...
  return (
    <AnimationWrapper>
      <section className='w-screen min-h-screen grid items-center lg:grid-cols-2 py-8 lg:gap-4 '>
        <Toaster/>
        ...
        <div className='max-w[550px] center'>
          ...
          <p className='font-gelasio text-xl leading-tight line-clamp-2 mt-4'>{des}</p>
        ...
        <div className='border-grey lg:border-1 lg:pl-8'>
          ...
          <p className='text-dark-grey mb-2 mt-9'>Topics-( Helps in searching and ranking you blog post)</p>
