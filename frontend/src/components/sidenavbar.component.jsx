            ...
            <section className="relative flex gap-10 py-0 m-0 max-md:flex-col">
                <div className="sticky z-30">
                    ...
                    <div className="md:hidden bg-white py-1 border-b border-grey flex flex-nowrap overflow-x-auto">
                        <button ref={sideBarIcon} onClick={changePageState} className="p-5 capitalize">
                            <MenuOpenIcon className="pointer-events-none"/>
                        </button>
                    ...
                    <div className={"min-w-[200px] h-[calc(100vh-80px-65px)] md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-grey md:border-r absolute max-md:top-[64px] bg-white max-md:w-[calc(100%+80px)] max-md:px-16 max-md:-ml-7 duration-500 " + (!showSideNav ? "max-md:opacity-0 max-md:pointer-events-none" : "opacity-100 pointer-events-auto")}>
