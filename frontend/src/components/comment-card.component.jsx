...
const CommentCard=({index, leftVal, commentData})=>{
    ...
    let {blog, blog:{activity, activity:{total_parent_comments}, comments, comments:{results:commentsArr}, author:{personal_info:{username:blog_author}}}, setBlog, setTotalParentCommentsLoaded}=useContext(BlogContext)
    ...
    const LoadMoreRepliesButton=()=>{
        ...
        let button=<button onClick={()=>loadReplies({skip: index - parentIndex, currentIndex: parentIndex})} className="text-dark-grey p-2 px-3 hover:bg-grey rounded-md flex items-center gap-2">Load More Replies</button>
